...
const porcentajeadecuado = words.get('porcentajeadecuado');
...
<p>En cuanto a la graduaci&oacute;n del porcentaje de aplicaci&oacute;n la STS 19-01-96, recurso 536/1995, se&ntilde;ala que el art. 123 de la LGSS no contiene criterios precisos en lo que se refiere a la fijaci&oacute;n del porcentaje, pero si mandata una directriz general para la concreci&oacute;n del referido recargo que no es otro que la &ldquo;gravedad de la falta&rdquo;, lo que supone reconocer un amplio margen de discrecionalidad al Juez en la instancia siempre y cuando act&uacute;e con par&aacute;metros de racionalidad y proporci&oacute;n en la fundamentaci&oacute;n del porcentaje, con la posibilidad de control ulterior por el &oacute;rgano &ldquo;ad quem&rdquo;.</p>
...
<h4>FALLO</h4>
<p>Estimo parcialmente la demanda de recargo de prestaciones interpuesta por <span class="word" title="id: actor">${actor}</span> frente al Instituto Nacional de la Seguridad Social, la Tesorer&iacute;a General del Seguridad Social y la persona trabajadora &nbsp;<span class="word" title="id: demandado">${demandado}</span>, y por ende revoco y dejo sin efecto la Resolución de fecha <span class="word" title="id: fecharesolucionrecargo">${fecharesolucionrecargo}</span> de la Dirección Provincial del Instituto Nacional de la Seguridad Social, únicamente en lo relativo al porcentaje del recargo impuesto por falta de medidas de seguridad, declarando que el procedente ha de ser el del <span class="word" title="id: porcentajeadecuado">${porcentajeadecuado}</span>%, condenado a las partes a estar y pasar por tal declaración.</p>
