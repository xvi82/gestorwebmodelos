...
<h4>FALLO</h4>
<p>Desestimo la demanda de recargo de prestaciones interpuesta por <span class="word" title="id: actor">${actor}</span> frente al Instituto Nacional de la Seguridad Social, la Tesorer&iacute;a General del Seguridad Social y la persona trabajadora &nbsp;<span class="word" title="id: demandado">${demandado}</span>, y por ende declaro ajustada a derecho la imposici&oacute;n del Recargo del <span class="word" title="id: porcentajerecargo">${porcentajerecargo}</span>% sobre las prestaciones econ&oacute;micas derivadas del accidente de trabajo, confirmando en consecuencia la Resoluci&oacute;n Administrativa de fecha <span class="word" title="id: fecharesolucionrecargo">${fecharesolucionrecargo}</span>; impugnada en el presente procedimiento</p>
